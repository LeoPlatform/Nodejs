...
module.exports = function (configure) {
	...
	function deleteByQuery (context, event, data, client, callback) {
	...
	let self = {
		...
		stream: function (settings) {
			...
			let format = ls.through({
				...
				deleteByQuery(this, event, data, client, done);
