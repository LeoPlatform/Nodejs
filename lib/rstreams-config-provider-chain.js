...
exports.AWSSecretsConfiguration = aws_util_1.default.inherit(rstreams_configuration_1.default, {
    ...
    refreshSync: function () {
        ...
        let cachedValue = exports.AWSSecretsConfiguration.valueCache[cacheKey];
        if (cachedValue != null && cachedValue.expireTime >= Date.now()) {
            values = cachedValue.data;
        }
        else {
            delete exports.AWSSecretsConfiguration.valueCache[cacheKey];
        }
        if (values == null) {
            let error;
            try {
            ...
            exports.AWSSecretsConfiguration.valueCache[cacheKey] = {
...
exports.AWSSecretsConfiguration.valueCache = {};
exports.AWSSecretsConfiguration.clearCache = function () {
    exports.AWSSecretsConfiguration.valueCache = {};
};
