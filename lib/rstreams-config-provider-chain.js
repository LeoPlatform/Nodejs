...
exports.AWSSecretsConfiguration = exports.ObjectConfiguration = exports.LeoConfiguration = exports.FileTreeConfiguration = exports.EnvironmentConfiguration = exports.ConfigProviderChain = exports.ProvidersInputType = exports.ConfigurationOptions = void 0;
...
exports.FileTreeConfiguration = util_1.default.inherit(rstreams_configuration_1.default, {
    ...
    refresh: function refresh(callback) {
        ...
        if (values == null) {
            callback(util_1.default.error(new Error(`Unable to parse env variable: ${this.envPrefix}`), { code: 'FileTreeConfigurationProviderFailure', errors: errors }));
            return;
        }
        this.expired = false;
        rstreams_configuration_1.default.call(this, values);
