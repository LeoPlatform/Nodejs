 ...
 */
const Configuration = util_1.default.inherit({
    /**
     * A credentials object can be created using positional arguments or an options
     * hash.
     *
     * @overload RStreams.Configuration(accessKeyId, secretAccessKey, sessionToken=null)
     ...
     *     var creds = new RStreams.Configuration('akid', 'secret', 'session');
     * @overload RStreams.Configuration(options)
     *   Creates a Credentials object with a given set of credential information
     *   as an options hash.
     ...
     *   @example Create a credentials object with AWS credentials
     *     var creds = new RStreams.Configuration({
    ...
    needsRefresh: function needsRefresh() {
        var currentTime = util_1.default.date.getDate().getTime();
    ...
    coalesceRefresh: function coalesceRefresh(callback, sync) {
        ...
        if (self.refreshCallbacks.push(callback) === 1) {
            self.load(function onLoad(err) {
                util_1.default.arrayEach(self.refreshCallbacks, function (callback) {
                    if (sync) {
                        callback(err);
                    }
                    else {
...
Configuration.addPromisesToClass = function addPromisesToClass(PromiseDependency) {
    this.prototype.getPromise = util_1.default.promisifyMethod('get', PromiseDependency);
    this.prototype.refreshPromise = util_1.default.promisifyMethod('refresh', PromiseDependency);
};
Configuration.deletePromisesFromClass = function deletePromisesFromClass() {
    delete this.prototype.getPromise;
    delete this.prototype.refreshPromise;
};
util_1.default.addPromises(Configuration);
