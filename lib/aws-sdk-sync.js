...
exports.CloudFormation = exports.STS = exports.SSM = exports.DynamoDB = exports.S3 = exports.SecretsManager = exports.Service = exports.invoke = void 0;
...
function invoke(req, service, method, config, params, packageName) {
    let hasLogged = false;
    try {
...
function run(service, method, config, params, packageName) {
...
exports.STS = STS;
class CloudFormation extends Service {
    constructor() {
        super(...arguments);
        this.packageName = "@aws-sdk/client-cloudformation";
    }
    listExports(params) {
