...
module.exports = function (configure) {
	...
	configure.onUpdate((newConfigure) => {
		logger.log("lib/cron.js config changed");

		CRON_TABLE = newConfigure.resources.LeoCron;
		SETTINGS_TABLE = newConfigure.resources.LeoSettings;
		SYSTEM_TABLE = newConfigure.resources.LeoSystem;
	});
