...
module.exports = function(configure) {
	...
	const connectTimeout = process.env.DYNAMODB_CONNECT_TIMEOUT_MS ? parseInt(process.env.DYNAMODB_CONNECT_TIMEOUT_MS) : 5000;
	const dynamoTimeout = process.env.DYNAMODB_TIMEOUT_MS ? parseInt(process.env.DYNAMODB_TIMEOUT_MS) : 5000;
