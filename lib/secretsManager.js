...
module.exports = function(configuration) {
	return {
		getSecret: function(secretName, opts) {
			...
			console.log(`leo-sdk/lib/secretsManager is deprecated and will be removed. Instead, please use: require('leo-aws').secrets.getSecret('secretName')`);
			console.log('########################################################### END DEPRECATED WARNING ##################################################');
