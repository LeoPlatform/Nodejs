...
module.exports = function(configure) {
	...
	var ls = {
		 ...
		 * fromLeo
		 * 
		 * Creates a pipeline to read events from a Leo stream.
		 * 
		 * @param {string} ID - The ID of the bot reading from the stream.
		 * @param {string} queue - The name of the queue to read from.
		 * @param {object} opts - Options for reading from the stream, including start time, limit, and buffer size.
		 * @returns {stream} A pipeline that reads events from the specified queue.
		 */
