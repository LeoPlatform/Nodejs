...
const kinesisStreamProcessor = require("../kinesis-stream-processor");
...
module.exports = function(configure) {
	...
	var ls = {
		...
		toLeo: (ID, opts) => {
			...
			const putRecords = (process.env.DISABLE_KINESIS == "true" || opts.disable_kinesis) ? (...args) => kinesisStreamProcessor.putRecords.call(ls, ...args) : kinesis.putRecords;
